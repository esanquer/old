...
public class EntreeEquipementUI extends Circle implements ComposantUI, PointUI
{
        /*##############################
                 ATRIBUT
        ##############################*/
    ...
    private double posXInEquipement;
    private double posYInEquipement;
    ...
    public EntreeEquipementUI(){}
    public EntreeEquipementUI(double posX, double posY, EquipementUI equipement) {
        
        this.idInEquipement =equipement.getEntreeEquipement().size();
        ...
        this.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                StaticHandler.selectionEntreeEquipement((EntreeEquipementUI)mouseEvent.getSource());
            }
        }); 
    }
    ...
    public void verifieConformite(){
        if(this.getConvoyeur()==null){
            if(!this.getStyleClass().contains("equipement-error"))
